...
module nios_system_mm_interconnect_0 (
		...
		input  wire [17:0] nios2_processor_data_master_address,                 //                   nios2_processor_data_master.address
		...
		input  wire [17:0] nios2_processor_instruction_master_address,          //            nios2_processor_instruction_master.address
	...
	wire  [17:0] nios2_processor_data_master_translator_avalon_universal_master_0_address;              // nios2_processor_data_master_translator:uav_address -> nios2_processor_data_master_agent:av_address
	...
	wire  [17:0] nios2_processor_instruction_master_translator_avalon_universal_master_0_address;       // nios2_processor_instruction_master_translator:uav_address -> nios2_processor_instruction_master_agent:av_address
	...
	wire  [17:0] nios2_processor_jtag_debug_module_agent_m0_address;                                    // nios2_processor_jtag_debug_module_agent:m0_address -> nios2_processor_jtag_debug_module_translator:uav_address
	...
	wire  [94:0] leds_s1_agent_rf_source_data;                                                          // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] leds_s1_agent_rsp_fifo_out_data;                                                       // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                                  // cmd_mux_003:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [17:0] switchs_s1_agent_m0_address;                                                           // switchs_s1_agent:m0_address -> switchs_s1_translator:uav_address
	...
	wire  [94:0] switchs_s1_agent_rf_source_data;                                                       // switchs_s1_agent:rf_source_data -> switchs_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] switchs_s1_agent_rsp_fifo_out_data;                                                    // switchs_s1_agent_rsp_fifo:out_data -> switchs_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                                 // cmd_mux_004:src_valid -> switchs_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> switchs_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                                 // switchs_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> switchs_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                         // cmd_mux_004:src_startofpacket -> switchs_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                           // cmd_mux_004:src_endofpacket -> switchs_s1_agent:cp_endofpacket
	...
	wire  [93:0] leds_s1_agent_rp_data;                                                                 // LEDs_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] switchs_s1_agent_rp_data;                                                              // switchs_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [93:0] router_src_data;                                                                       // router:src_data -> nios2_processor_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                      // nios2_processor_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [4:0] router_src_channel;                                                                    // router:src_channel -> nios2_processor_data_master_limiter:cmd_sink_channel
	...
	wire  [93:0] nios2_processor_data_master_limiter_cmd_src_data;                                      // nios2_processor_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire   [4:0] nios2_processor_data_master_limiter_cmd_src_channel;                                   // nios2_processor_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [93:0] rsp_mux_src_data;                                                                      // rsp_mux:src_data -> nios2_processor_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                                     // nios2_processor_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_limiter:rsp_sink_channel
	...
	wire  [93:0] nios2_processor_data_master_limiter_rsp_src_data;                                      // nios2_processor_data_master_limiter:rsp_src_data -> nios2_processor_data_master_agent:rp_data
	...
	wire   [4:0] nios2_processor_data_master_limiter_rsp_src_channel;                                   // nios2_processor_data_master_limiter:rsp_src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire  [93:0] router_001_src_data;                                                                   // router_001:src_data -> nios2_processor_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                                  // nios2_processor_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [4:0] router_001_src_channel;                                                                // router_001:src_channel -> nios2_processor_instruction_master_limiter:cmd_sink_channel
	...
	wire  [93:0] nios2_processor_instruction_master_limiter_cmd_src_data;                               // nios2_processor_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [4:0] nios2_processor_instruction_master_limiter_cmd_src_channel;                            // nios2_processor_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [93:0] rsp_mux_001_src_data;                                                                  // rsp_mux_001:src_data -> nios2_processor_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                                 // nios2_processor_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_limiter:rsp_sink_channel
	...
	wire  [93:0] nios2_processor_instruction_master_limiter_rsp_src_data;                               // nios2_processor_instruction_master_limiter:rsp_src_data -> nios2_processor_instruction_master_agent:rp_data
	...
	wire   [4:0] nios2_processor_instruction_master_limiter_rsp_src_channel;                            // nios2_processor_instruction_master_limiter:rsp_src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire   [4:0] nios2_processor_data_master_limiter_cmd_valid_data;                                    // nios2_processor_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [4:0] nios2_processor_instruction_master_limiter_cmd_valid_data;                             // nios2_processor_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         switchs_s1_agent_rdata_fifo_src_valid;                                                 // switchs_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] switchs_s1_agent_rdata_fifo_src_data;                                                  // switchs_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         switchs_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_004:in_0_ready -> switchs_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                     // avalon_st_adapter_004:out_0_valid -> switchs_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                      // avalon_st_adapter_004:out_0_data -> switchs_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                     // switchs_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                     // avalon_st_adapter_004:out_0_error -> switchs_s1_agent:rdata_fifo_sink_error
